...
public class DevUtil {
    ...
    public String  get_run_bExLimit_title(){return "高水位极限状态";}
    public Byte     get_run_bExLimit_value(){return run_bExLimit;}
    public String  get_run_bExLimit_valAlias(){
        switch (run_bExLimit){
            case 1:
                return "正常";
            case 2:
    ...
    public String  get_run_bHSensorErr_title(){return "热传感器状态";}
    public Byte     get_run_bHSensorErr_value(){return run_bHSensorErr;}
    public String  get_run_bHSensorErr_valAlias(){
        switch (run_bHSensorErr){
            case 1:
                return "正常";
            case 2:
                return "开路";
    ...
    public String  get_run_bCSensorErr_title(){return "冷传感器状态";}
    public Byte     get_run_bCSensorErr_value(){return run_bCSensorErr;}
    public String  get_run_bCSensorErr_valAlias(){
        switch (run_bCSensorErr){
            case 1:
                return "正常";
            case 2:
                return "开路";
    ...
    public byte get_ioRunData(){
        ...
        run_bCup     = buf[ip+13];
        run_bExLimit     = buf[ip+14];
        run_bHSensorErr  = buf[ip+15];
        run_bCSensorErr  = buf[ip+16];
    ...
    */
    ...
    public String[][] toArray() {
        ...
        data[24][0] = get_run_bExLimit_title();
        data[24][1] = get_run_bExLimit_valAlias();

        data[25][0] = get_run_bHSensorErr_title();
        data[25][1] = get_run_bHSensorErr_valAlias();

        data[26][0] = get_run_bCSensorErr_title();
        data[26][1] = get_run_bCSensorErr_valAlias();
